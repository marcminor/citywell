	...
	*/
	function ThemeWidgetGalleryItems() {
		...
		$widget_opts = array(
			...
			'description' => __( 'Display one or more recent gallery items.','savior'));
		...
		$this->WP_Widget('theme-widget-galleries', __('[SAVIOR] Gallery Widget','savior'), $widget_opts, $control_ops);
		$this->custom_fields = array(
			array(
				'name'=>'title',
				'type'=>'text',
				'title'=>__('Title','savior'), 
				'default'=>__('Galleries','savior')
			),
			array(
				'name'=>'categories',
				...
				'title'=>__('Gallery Categories','savior'),
				'default'=>''
			),
			array(
				'name'=>'load',
