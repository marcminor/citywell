<?php
	...
	echo "<div class='wrap'>\n";
	echo $this->add_wrap(__('Event Calendar Options', AEC_NAME), "<h2><span class='em-icon icon32'></span>", "</h2>");
	...
	$form .= $this->add_wrap(__("Date Format, Time Format, and Week Start settings are ", AEC_NAME), "<span class='fr helptip round5'>", " ");
	$form .= $this->add_wrap(__("located here", AEC_NAME), "<a href='" . ADMIN_URL(). "options-general.php'>", "</a>.</span>");
